...
[![module formats: umd, cjs, and esm](https://img.shields.io/badge/module%20formats-umd%2c%20cjs%2c%20esm-green.svg?style=flat)](https://unpkg.com/@rbalazsi/dnd-shadow-dom/dist/)

## General

1. Add the `@rbalazsi/dnd-shadow-dom` package

```bash
# npm
npm install @rbalazsi/dnd-shadow-dom --save

# pnpm
pnpm add @rbalazsi/dnd-shadow-dom

# yarn
yarn add @rbalazsi/dnd-shadow-dom
```
...
In order to use `@rbalazsi/dnd-shadow-dom` you will probably want to have a `React` environment set up.
...
You can use the UMD to run `@rbalazsi/dnd-shadow-dom` directly in the browser.

```html
<!-- peer dependency -->
<script src="https://unpkg.com/react@16.3.1/umd/react.development.js"></script>
<!-- lib (change x.x.x for the version you would like) -->
<script src="https://unpkg.com/@rbalazsi/dnd-shadow-dom@x.x.x/dist/dnd.js"></script>
...
You can consume `@rbalazsi/dnd-shadow-dom` from within `ClojureScript` using [CLJSJS](https://cljsjs.github.io/)!
