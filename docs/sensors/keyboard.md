...
When dragging with a keyboard, `@rbalazsi/dnd-shadow-dom` will also perform [auto scrolling](/docs/guides/auto-scrolling.md) operations to ensure the item can be moved around
